...
class Test(unittest.TestCase):
    ...
    def test_get_config(self):
        ...
        self.assertEqual(config['rand_wc_model_gen']['kb_gen']['component']['ChromosomesGenesTusGenerator']['num_chromosomes'], 1)
        self.assertEqual(config['rand_wc_model_gen']['kb_gen']['component']['ChromosomesGenesTusGenerator']['mean_gc_frac'], 0.5)
    ...
    def test_get_config_extra_path(self):
        ...
        self.assertEqual(config['rand_wc_model_gen']['kb_gen']['component']['ChromosomesGenesTusGenerator']['num_chromosomes'], 5)
        self.assertEqual(config['rand_wc_model_gen']['kb_gen']['component']['ChromosomesGenesTusGenerator']['mean_gc_frac'], 0.5)
    ...
    def test_get_config_extra_vals(self):
        ...
        self.assertEqual(config['rand_wc_model_gen']['kb_gen']['component']['ChromosomesGenesTusGenerator']['num_chromosomes'], 10)
        self.assertEqual(config['rand_wc_model_gen']['kb_gen']['component']['ChromosomesGenesTusGenerator']['mean_gc_frac'], 0.5)
