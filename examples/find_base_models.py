...
model_core = os.path.join(os.path.dirname(__file__), '../random_wc_model_generator/data/fixtures', 'model_core.xlsx')
...
rxn_1.participants.create(species=species_list[0], coefficient=1)
rxn_2.participants.create(species=species_list[0], coefficient=1)
